...
class CallActivity : ComponentActivity() {
    ...
    private val CALL_TIMEOUT = 30000L
            ...
            CallKitTheme {
                Surface(
                    ...
                    CallScreen(
                        ...
                        onAccept = { acceptCall(callerName) },
                        onDecline = { declineCall(callerName) }
                    )
                }
            }
        }
    ...
    private fun handleMissedCall(callerName: String) {
        ...
        CallKit.notifyCallMissed(callerName)
    ...
    private fun declineCall(callerName: String) {
        timeoutJob?.cancel()
        cancelIncomingCallNotification()
